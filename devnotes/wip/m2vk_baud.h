...
// Read once from M2VK_LAZY_BAUD: 0 = off (stock CLOCK), 1 = demand-gated (default), 2 = eager (this
// device, but a timer for every edge — the diagnostic control, not a shipping mode).
bool enabled();
bool tx_eager();
bool rx_eager();
