...
Built 2026-09-01, off the finding in [plan_model2_quantum.md](plan_model2_quantum.md): every Model 2
...
([m1audio-thread-plan.md](m1audio-thread-plan.md)), and it confounded two rounds of hand-checking here
