...
Read with [android.md](android.md) (Mac-written; §2's brew/NDK notes do not apply) and
[roms.md](roms.md) (Mac paths throughout).
...
is in **[windows.md](windows.md)** — that file, not this one, is the standing reference for working
...
2. New `devnotes/windows.md`: what is installed on this box and where (the table in §1), the two
