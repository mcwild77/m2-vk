...
2. ✅ **Compat matrix.** [compatibility.md](../reference/compatibility.md) rewritten as one Track-D matrix across all
...
- **Licence chores** ([legalstuff.md](../reference/legalstuff.md) §9, do not touch that file otherwise): tag the
