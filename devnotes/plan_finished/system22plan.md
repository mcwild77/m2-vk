...
`devnotes/reference/compatibility.md` is currently a 29-row Model 2 play-test table with useful hand-notes but no
...
2. **Track D — the combined compatibility matrix.** [compatibility.md](../reference/compatibility.md) has S21 rows
