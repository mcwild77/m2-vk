...
makes the core presentable is the R-series in [shippable-plan.md](shippable-plan.md), absorbed by
...
- Legal drop per [legalstuff.md](legalstuff.md) §9: `COPYING` + `docs/legal/`, declare
...
The **R-series** ([shippable-plan.md](shippable-plan.md) / [modelizer-plan.md](modelizer-plan.md)) is
