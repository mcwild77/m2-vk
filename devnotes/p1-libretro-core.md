...
`../Polydiver/PDDocs/model2/model2_libretro_core.md` §3. Read [seam.md](seam.md) first for what P0
...
options — [user-options.md](user-options.md) §4 and §5 are the scoping, and the current list is always
...
`None`. The reason is in [lightgun.md](lightgun.md) §2.5.3: **L3/R3 are `"nul"` in RetroArch's default
...
> ⚠️ **CORRECTED 2026-07-29 — see [savestates.md](savestates.md). Kept in place rather than rewritten,
...
frame-100 line reproduces the VF2 numbers recorded in [seam.md](seam.md) exactly.
...
- **Model 2 video code is moving upstream** (microtextures Oct 2025, front-to-back fill buffer
  Nov 2025 — see [feature-survey.md](feature-survey.md)). The ground truth P1 generates has a
