...
--   devnotes/plan_finished/p2-vulkan-passthrough.md for the consequences.
--
...
project ("osd_" .. _OPTIONS["osd"])
	...
	files {
		...
		-- see devnotes/plan_finished/p2-vulkan-passthrough.md for why the shaders are compiled offline.
